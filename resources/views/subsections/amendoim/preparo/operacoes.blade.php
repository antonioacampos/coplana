    ...
    <div class="card-body">
        ...
        <form action="{{ route('calcular') }}" method="POST">
            ...
            <div class="form-group">
                <label for="number1">Digite o custo unitário da passagem da gradagem pesada:</label>
            ...
            <div class="form-group">
                <label for="number2">Digite o custo unitário da passagem da aração (Iveca):</label>
            ...
            <div class="form-group">
                <label for="number3">Digite o custo unitário da passagem da gradagem intermediária:</label>
            ...
            <div class="form-group">
                <label for="number4">Digite o custo unitário da passagem da gradagem niveladora:</label>
            ...
            <div class="form-group">
                <label for="number5">Digite o custo unitário da passagem da enxada rotativa (canteirização):</label>
            ...
            <div class="form-group">
                <label for="number6">Digite o custo unitário da passagem da subssolagem:</label>
            ...
            <div class="form-group">
                <label for="number7">Digite o custo unitário da aplicação da pulverização de dessecação pré-plantio:</label>
        ...
        <div class="mt-4 text-center">
            ...
            <div id="individualResults" class="mt-3" style="display:none;">
                <p>Gradagem pesada (1 passagem/ha): <input type="text" class="form-control" value="{{ $result1 }}" readonly></p>
                <p>Aração - Iveca (1 passagem/ha): <input type="text" class="form-control" value="{{ $result2 }}" readonly></p>
                <p>Gradagem intermediária (1 passagem/ha): <input type="text" class="form-control" value="{{ $result3 }}" readonly></p>
                <p>Gradagem niveladora (1 passagem/ha): <input type="text" class="form-control" value="{{ $result4 }}" readonly></p>
                <p>Enxada rotativa (1 passagem/ha): <input type="text" class="form-control" value="{{ $result5 }}" readonly></p>
                <p>subssolagem (1 passagem/ha): <input type="text" class="form-control" value="{{ $result6 }}" readonly></p>
                <p>Pulverização de dessecação pré-plantio (1 aplicação/ha): <input type="text" class="form-control" value="{{ $result7 }}" readonly></p>
            </div>
        </div>
        @endif
    </div>
