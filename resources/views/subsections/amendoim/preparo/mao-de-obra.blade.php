    ...
    <div class="card-body">
        ...
        <form action="{{ route('calcular') }}" method="POST">
            ...
            <div class="form-group">
                <label for="number1">Digite o custo unitário da hora de 1 operador de trator agrícola:</label>
            ...
            <div class="form-group">
                <label for="number2">Digite o custo unitário da hora de 1 trabalhador agrícola auxiliar:</label>
            ...
            <div class="form-group">
                <label for="number3">Digite o custo unitário da hora de 1 técnico agrícola:</label>
            ...
            <div class="form-group">
                <label for="number4">Digite o custo unitário da hora de 1 técnico em mecanização agrícola:</label>
            ...
            <div class="form-group">
                <label for="number5">Digite o custo unitário da hora de 1 supervisor de campo:</label>
            ...
            <div class="form-group">
                <label for="number6">Digite o custo unitário da hora de 1 supervisor e administrador:</label>
            ...
            <div class="form-group">
                <label for="number7">Digite o custo unitário da hora de 1 motorista de caminhão:</label>
        ...
        <div class="mt-4 text-center">
            ...
            <div id="individualResults" class="mt-3" style="display:none;">
                <p>2 operadores de trator agrícola (8h/ha): <input type="text" class="form-control" value="{{ $result1 }}" readonly></p>
                <p>2 trabalhadores agrícolas auxiliares (6h/ha): <input type="text" class="form-control" value="{{ $result2 }}" readonly></p>
                <p>1 técnico agrícola (2h/ha): <input type="text" class="form-control" value="{{ $result3 }}" readonly></p>
                <p>1 técnico em mecanização agrícola  (1h/ha): <input type="text" class="form-control" value="{{ $result4 }}" readonly></p>
                <p>1 supervisor de campo (2h/ha): <input type="text" class="form-control" value="{{ $result5 }}" readonly></p>
                <p>1 supervisor e administrador (1h/ha): <input type="text" class="form-control" value="{{ $result6 }}" readonly></p>
                <p>2 motoristas de caminhão (2h/ha): <input type="text" class="form-control" value="{{ $result7 }}" readonly></p>
            </div>
        </div>
        @endif
    </div>
